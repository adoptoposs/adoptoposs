...
#   - https://hub.docker.com/_/debian?tab=tags&page=1&name=buster-20231009-slim - for the release image
#   - https://pkgs.org/ - resource for finding needed packages
#   - Ex: hexpm/elixir:1.15.7-erlang-26.1.2-debian-buster-20231009-slim
#
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/adoptoposs ./
