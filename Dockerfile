...
#   - https://hub.docker.com/_/debian?tab=tags&page=1&name=buster-20230612-slim - for the release image
#   - https://pkgs.org/ - resource for finding needed packages
#   - Ex: hexpm/elixir:1.15.6-erlang-26.1-debian-buster-20230612-slim
#
